...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, default='./data/AAPM-Mayo-CT-Challenge/')
    parser.add_argument('--save_path', type=str, default='./data/aapm_npy_img/')
